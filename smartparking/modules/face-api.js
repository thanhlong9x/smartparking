...
function MSCSFaceApi(key, server) {
	...
	const FINDSIMILARS = `${API}/findsimilars`;
	const GROUP = `${API}/group`;
	const IDENTIFY = `${API}/identify`;
	const VERIFY = `${API}/verify`;
	const FACELISTS = `${API}/facelists`;
	...
	function deletePerson(personGroupId, personId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "delete",
				url: `${PERSON_GROUP}/${personGroupId}/persons/${personId}`,
				headers: HEADERS,
			}).then(function (res) {
				resolve(res);
			}).catch(function (err) {
	...
	function deletePersonFace(personGroupId, personId, persistedFaceId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "delete",
				url: `${PERSON_GROUP}/${personGroupId}/persons/${personId}/persistedFaces/${persistedFaceId}`,
				headers: HEADERS,
			}).then(function (res) {
				resolve(res);
			}).catch(function (err) {
	...
	function getAPerson(personGroupId, personId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "get",
				url: `${PERSON_GROUP}/${personGroupId}/persons/${personId}`,
	...
	function getAPersonFace(personGroupId, personId, persistedFaceId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "get",
				url: `${PERSON_GROUP}/${personGroupId}/persons/${personId}/persistedFaces/${persistedFaceId}`,
	...
	function updateAPerson(personGroupId, personId, userData) {
		return new Promise((resolve, reject) => {
			axios({
				method: "patch",
				url: `${PERSON_GROUP}/${personGroupId}/persons/${personId}`,
	...
	function updateAPersonFace(personGroupId, personId, persistedFaceId, userData) {
		return new Promise((resolve, reject) => {
			axios({
				method: "patch",
				url: `${PERSON_GROUP}/${personGroupId}/persons/${personId}/persistedFaces/${persistedFaceId}`,
	...
	function findSimilar(faceIds, faceListId, maxNumOfCandidatesReturned, mode) {
		return new Promise((resolve, reject) => {
			axios({
				method: "post",
				url: `${FINDSIMILARS}`,
	...
	function verify(faceId,personId,personGroupId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "post",
				url: `${VERIFY}`,
	...
	function createFaceLists(personGroupId, name, userData) {
		return new Promise((resolve, reject) => {
			axios({
				method: "put",
	...
	function addFacetoFaceList(faceListId, targetFace, userData,url) {
		return new Promise((resolve, reject) => {
			axios({
				method: "post",
				url: `${FACELISTS}/${faceListId}/persistedFaces?userData=${userData}&targetFace=${targetFace}`,
				headers: HEADERS,
				data: {
					"url": url
				}
	...
	function deleteFaceInFaceList(faceListId,persistedFaceId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "delete",
	...
	function deleteaFaceList(faceListId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "delete",
				url: `${FACELISTS}/${faceListId}`,
	...
	function getAFaceList(faceListId) {
		return new Promise((resolve, reject) => {
			axios({
				method: "get",
				url: `${FACELISTS}/${faceListId}`,
	...
	function updateAFaceList(faceListId, name, userData) {
		return new Promise((resolve, reject) => {
			axios({
				method: "patch",
				url: `${FACELISTS}/${faceListId}`,
